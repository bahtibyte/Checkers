	...
	public class Screen extends JPanel implements ActionListener, KeyListener {
	        ...
	        public void mousePressed(MouseEvent m) {
	            ...
	            if (m.getX() >= 820 && m.getX() <= 985){
	                ...
	                if (m.getY() >= 490 && m.getY() <= 540){
	                    if (showCoords) {
	                        Log.log("Settings - Coords are now hidden");
	                        showCoords = false;
	                    }else {
	                        Log.log("Settings - Coords are now showen");
	                        showCoords = true;
	                    }
	                }else if (m.getY() >= 560 && m.getY() <= 610){
	                    if (showMoves) {
	                        Log.log("Settings - Possible Moves are now hidden");
	                        showMoves = false;
	                    }else {
	                        Log.log("Settings - Possible Moves are now showen");
	                        showMoves = true;
	                    }
	                }else if (m.getY() >= 335 && m.getY() <= 385){
	                    gameMode = PvAI;
	                    Log.log("\nNew Game");
	                    Log.log("Game Mode - Player vs AI set");
	                    resetClicks();
	                    setCheckers();
	                    randomPlayer();
	                    ...
	                    setCheckers();
	                    randomPlayer();
	                    Log.log("Game Mode - Player vs Player set");
	                }
	                                ...
	                                if (playerTurn == playerRed){
	                                    ...
	                                    if (board[r][c] == playerRed){
	                                        ...
	                                        if (!click1 && !click2){
	                                            ...
	                                            c1x = r;
	                                            c1y = c;
	                                            Log.log("Click 1 set at ("+c1x+","+c1y+") (Red)");
	                                        }
	                                        ...
	                                        //Resets the first click
	                                            ...
	                                            c1x = r;
	                                            c1y = c;
	                                            Log.log("Click 1 Re-set at ("+c1x+","+c1y+") (Red)");
	                                        }
	                                    ...
	                                    //Red King Checker
	                                        ...
	                                        if (!click1 && !click2){
	                                            ...
	                                            c1x = r;
	                                            c1y = c;
	                                            Log.log("Click 1 set at ("+c1x+","+c1y+") (Red King)");
	                                        }
	                                        ...
	                                        //Resets the first click
	                                            ...
	                                            c1x = r;
	                                            c1y = c;
	                                            Log.log("Click 1 Re-set at ("+c1x+","+c1y+") (Red King");
	                                        }
	                                    ...
	                                    //2nd Click for Red
	                                        ...
	                                        c2x = r;
	                                        c2y = c;
	                                        Log.log("Click 2 set at ("+c2x+","+c2y+") ");
	                                ...
	                                if (playerTurn == playerBlue){
	                                    ...
	                                    if (board[r][c] == playerBlue){
	                                        ...
	                                        if (!click1 && !click2){
	                                            ...
	                                            c1x = r;
	                                            c1y = c;
	                                            Log.log("Click 1 set at ("+c1x+","+c1y+") (Blue)");
	                                        }
	                                        ...
	                                        //Re sets the first click
	                                            ...
	                                            c1x = r;
	                                            c1y = c;
	                                            Log.log("Click 1 Re-set at ("+c1x+","+c1y+") (Blue)");
	                                        }
	                                    ...
	                                    //Blue King Checker
	                                        ...
	                                        if (!click1 && !click2){
	                                            ...
	                                            c1x = r;
	                                            c1y = c;
	                                            Log.log("Click 1 set at ("+c1x+","+c1y+") (Blue King)");
	                                        }
	                                        ...
	                                        //Re sets the first click
	                                            ...
	                                            c1x = r;
	                                            c1y = c;
	                                            Log.log("Click 1 Re-set at ("+c1x+","+c1y+") (Blue King)");
	                                        }
	    ...
	    public void randomPlayer(){
	        ...
	        if (ran == 0 && gameMode == PvP){
	            Log.log("Player Blue starts first");
	            playerTurn = playerBlue;
	        }else if (ran == 1 && gameMode == PvP){
	            Log.log("Player Red starts first");
	    ...
	    public boolean normalMovement(int x1, int y1, int x2, int y2){
	        ...
	        if (board[x2][y2] != empty){
	            if (playerTurn == playerRed) {
	                Log.log("Player Red Invalid movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	            }if (playerTurn == playerBlue){
	                Log.log("Player Blue Invalid movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	            }
	            Log.log("Click 2 resetted");
	            click2 = false;
	            return false;
	        }
	        
	        //Log.log("x1: "+x1+" x2: "+x2+" y1: "+y1+" y2: "+y2);
	        
	        if (playerTurn == playerBlue){
	            if (x2+1 == x1 && y2-1 == y1){
	                Log.log("Player Blue movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	                return true;
	                ...
	                Log.log("Player Blue movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	                Log.log("Player Blue took over player Red at ("+(x1-1)+","+(y1+1)+")");
	                ...
	                Log.log("Player Blue movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	                Log.log("Player Blue took over player Red King at ("+(x1-1)+","+(y1+1)+")");
	                board[x1-1][y1+1] = empty;
	                checkersLeft[0]--;
	                return true;
	            }else if (x2+2 == x1 && y2+2 == y1 && board[x1-1][y1-1] == playerRedKing){
	                ...
	                Log.log("Player Blue invalid movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	                Log.log("Resetting all clicks - (Invalid Movement)");
	                resetClicks();
	            }
	        }
	            ...
	            if (x2-1 == x1 && y2+1 == y1){
	                Log.log("Player Red movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	                return true;
	            }else if (x2-1 == x1 && y2-1 == y1){
	                Log.log("Player Red movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	                return true;
	                ...
	                Log.log("Player Red movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	                Log.log("Player Red took over player Blue at ("+(x1+1)+","+(y1-1)+")");
	                board[x1+1][y1-1] = empty;
	                checkersLeft[1]--;
	                return true;
	            }else if (x2-2 == x1 && y2-2 == y1 && board[x1+1][y1+1] == playerBlue){
	                ...
	                Log.log("Player Red movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	                Log.log("Player Red took over player Blue King at ("+(x1+1)+","+(y1-1)+")");
	                board[x1+1][y1-1] = empty;
	                checkersLeft[1]--;
	                return true;
	            }else if (x2-2 == x1 && y2-2 == y1 && board[x1+1][y1+1] == playerBlueKing){
	                Log.log("Player Red movement from ("+x1+","+y1+")"+" to "+"("+x2+","+y2+")");
	                Log.log("Player Red King took over player Blue at ("+(x1+1)+","+(y1+1)+")");
	                board[x1+1][y1+1] = empty;
	                checkersLeft[1]--;
	                return true;
	            }else {
	    ...
	    public boolean kingMovement(int x1, int y1, int x2, int y2){
	        ...
	        if (playerTurn == playerBlue){
	            ...
	            if (countRed == 1){
	                ...
	                checkersLeft[0]--;
	                Log.log("Player Blue took over player Red at ("+redX+","+redY+")");
	        ...
	        if (playerTurn == playerRed){
	            ...
	            if (countBlue == 1){
	                ...
	                checkersLeft[1]--;
	                Log.log("Player Red took over player Blue at ("+blueX+","+blueY+")");
	    ...
	    public void moveChecker(int x1,int y1, int x2, int y2) {
	        ...
	        if (board[x1][y1] == playerTurn+2){
	            if (kingMovement(x1,y1,x2,y2)){
	                ...
	                if (gameMode == PvP){
	                    if (playerTurn == playerBlue){
	                        Log.log("Player Red turn");
	                        playerTurn = playerRed;
	                    }
	
	                    else {
	                        Log.log("Player Blue turn");
	                        playerTurn = playerBlue;
	                    }
	    ...
	    public boolean checkForKing(int x, int y){
	        if (x == 0){
	            ...
	            Log.log("Blue King set at ("+x+","+y+")");
	            return true;
	        }else if (x == 7){
	            Log.log("Red King set at ("+x+","+y+")");
	    ...
	    public void gameOver(){
	        ...
	        if (winner == playerRed){
	            Log.log("Game over: Winner Player Red");
	        }if (winner == playerBlue){
	            Log.log("Game over: Winner Player Blue");
	        }
	    }
